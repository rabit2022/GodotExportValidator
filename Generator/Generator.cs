...
public class SourceProvider
{
    ...
    string WriteAttribute(GeneratorAttributeSyntaxContext attribute)
    {
        ...
        var type = (attribute.TargetSymbol switch
        {
        ...
        // 3. 泛型 IEnumerable<T>
        if (type is INamedTypeSymbol { IsGenericType: true } gt
            && gt.OriginalDefinition.SpecialType == SpecialType.System_Collections_Generic_IEnumerable_T)
            return $"ValidateUtilities.ValidateCheckEnumerableValues(this, \"{name}\", {name});";
